...
export default function Navbar() {
  ...
  if (!mounted) {
    return (      <nav className="fixed w-full top-0 z-50 backdrop-blur-sm bg-white/75 dark:bg-black border-b border-neutral-200 dark:border-neutral-800">
        <div className="container mx-auto px-6 h-[10vh] flex items-center justify-between">
  ...
  return (    <nav className="fixed w-full top-0 z-50 backdrop-blur-sm bg-white dark:bg-black/75 border-b border-neutral-200 dark:border-neutral-800">
      <div className="container mx-auto px-6 h-[10vh] flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/" className="font-bold">
            APOD
